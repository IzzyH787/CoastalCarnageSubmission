...
if ('\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
