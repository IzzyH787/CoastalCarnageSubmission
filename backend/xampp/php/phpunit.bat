...
if "%PHPBIN%" == "" set PHPBIN=\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php\.\php.exe
if not exist "%PHPBIN%" if "%PHP_PEAR_PHP_BIN%" neq "" goto USE_PEAR_PATH
GOTO RUN
:USE_PEAR_PATH
set PHPBIN=%PHP_PEAR_PHP_BIN%
:RUN
"%PHPBIN%" "\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php\phpunit" %*
