...
FOR %%x IN ("\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=\Uni Work\WebGameDevelopment\NewProject\CoastalCarnage\backend\xampp\php\php.exe"
GOTO :INSTALLED
